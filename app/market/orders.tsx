...
const styles = StyleSheet.create({
  ...
  loaderText: { color: '#10b981', fontWeight: '900', letterSpacing: 2, fontSize: 10 },
  emptyState: { paddingVertical: 80, alignItems: 'center', opacity: 0.5 },
  emptyText: { color: 'white', fontWeight: 'bold', marginTop: 16, fontSize: 16 },
  browseBtn: { marginTop: 24, paddingHorizontal: 20, paddingVertical: 10, borderRadius: 12, backgroundColor: '#10b981' },
  browseBtnText: { color: '#000', fontWeight: '900', fontSize: 10, letterSpacing: 1 },
  orderCard: { padding: 20, marginBottom: 16, backgroundColor: '#0f1714' },
  orderHeader: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', marginBottom: 16 },
  orderId: { color: 'white', fontWeight: '900', fontSize: 10, letterSpacing: 1 },
  ...
  itemName: { color: 'rgba(255,255,255,0.6)', fontSize: 13, flex: 1 },
  itemQty: { color: '#10b981', fontSize: 12, fontWeight: 'bold', marginLeft: 12 },
  footer: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'flex-end', paddingTop: 16, borderTopWidth: 1, borderTopColor: 'rgba(255,255,255,0.05)' },
  totalLabel: { color: '#405045', fontSize: 9, fontWeight: '900', letterSpacing: 1, marginBottom: 4 },
  totalValue: { color: 'white', fontFamily: 'Display-Bold', fontSize: 18 },
  orderDate: { color: '#405045', fontSize: 10, fontWeight: '600' }
});
