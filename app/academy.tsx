...
export default function AcademyScreen() {
  ...
  const { data: content, isLoading: loadingContent, refetch } = useAcademyContent();
        ...
        <View style={{ paddingHorizontal: 24 }}>
          ...
          <View style={styles.statsRow}>
            <Card style={[styles.statBox, { backgroundColor: colors.cardBg, borderColor: colors.border }]}>
                ...
                <Text style={[styles.statLabel, { color: colors.textMuted }]}>LESSONS COMPLETED</Text>
            </Card>
            <Card style={[styles.statBox, { backgroundColor: colors.cardBg, borderColor: colors.border }]}>
                <Text style={[styles.statValue, { color: colors.gold }]}>{(progress?.length || 0) * 5}</Text>
                <Text style={[styles.statLabel, { color: colors.textMuted }]}>SCORE POINTS EARNED</Text>
            </Card>
          </View>
